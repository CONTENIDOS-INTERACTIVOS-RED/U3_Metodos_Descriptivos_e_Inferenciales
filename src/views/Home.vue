        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 En un mundo empresarial marcado por la digitalización y el volumen creciente de datos, contar con habilidades para analizar información de forma estratégica, se ha vuelto una ventaja competitiva esencial. En esta unidad, se exploran los métodos estadísticos descriptivos e inferenciales aplicados a la Inteligencia de Negocios, permitiendo transformar datos complejos en decisiones organizacionales, basadas en evidencia. A través de casos reales, herramientas computacionales y visualizaciones interactivas, el estudiante desarrollará competencias para aplicar modelos predictivos, automatizar procesos analíticos y generar recomendaciones que aporten valor a los procesos empresariales.
              
              p #[b ¡Prepárese para enfrentar desafíos reales con el poder del análisis estadístico aplicado!]
